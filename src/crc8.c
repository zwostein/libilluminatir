...
// Taken from: https://stackoverflow.com/questions/15169387/definitive-crc-for-c
//
...
// Return the CRC-8 of data[0..data_size-1] applied to the seed crc. This permits the
...
{
	if( data == NULL ) {
		return ILLUMINATIR_CRC8_INITIAL_SEED;
	}
